...
<div class="attendance-list-page">
    ...
    <div class="date-selector">
        <a href="/admin/attendance/staff/{{ $user->id }}?month={{ $prevMonth }}" class="date-selector-btn">
            <svg class="arrow-icon" xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#B3B3B3" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round">
        ...
        <span class="date-selector-current">
            <svg class="calendar-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none">
                <rect x="2" y="4" width="20" height="18" rx="3" stroke="#4d4d4d" stroke-width="1.2" fill="white"></rect>
                ...
                <polyline points="13.2 15.2 14.5 16.5 16.5 14.5" stroke="#4d4d4d" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></polyline>
            </svg>
            {{ $currentMonthDisplay }}
        </span>

        <a href="/admin/attendance/staff/{{ $user->id }}?month={{ $nextMonth }}" class="date-selector-btn">
